...
import { house27Water, house28Feather, house29SunDisk, house30Falcon } from '../assets/royal';
...
export function LegendContent() {
    ...
    const sacredHouses = [
        ...
        { num: 27, icon: house27Water, type: 'svg' },
        { num: 28, icon: house28Feather, type: 'svg' },
        { num: 29, icon: house29SunDisk, type: 'svg' },
        { num: 30, icon: house30Falcon, type: 'svg' }
    ];
