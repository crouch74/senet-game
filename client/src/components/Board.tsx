...
export function Board() {
    ...
    return (
        <div className="relative w-full max-w-5xl mx-auto border-[10px] sm:border-[12px] md:border-[16px] border-[#1A1110] rounded-md bg-[#1A1110] shadow-[0_20px_50px_rgba(0,0,0,0.6),inset_0_0_15px_rgba(0,0,0,0.8)] p-[2px] sm:p-[3px] md:p-[4px] jitter-stroke">
